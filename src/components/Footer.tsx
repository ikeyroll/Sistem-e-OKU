        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
          ...
          <div className="flex flex-col items-center md:items-end gap-4">
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/maborongmphs" target="_blank" rel="noopener noreferrer" className="p-2 bg-primary/10 rounded-full hover:bg-primary/20 transition-colors">
                <Facebook className="h-5 w-5 text-primary" />
              </a>
              <a href="https://www.instagram.com/mpaborong_mphs" target="_blank" rel="noopener noreferrer" className="p-2 bg-primary/10 rounded-full hover:bg-primary/20 transition-colors">
                <Instagram className="h-5 w-5 text-primary" />
              </a>
              <a href="https://www.youtube.com/@MajlisPerbandranHuluSelango" target="_blank" rel="noopener noreferrer" className="p-2 bg-primary/10 rounded-full hover:bg-primary/20 transition-colors">
                <Youtube className="h-5 w-5 text-primary" />
              </a>
              <a href="https://www.tiktok.com/@mphs_official" target="_blank" rel="noopener noreferrer" className="p-2 bg-primary/10 rounded-full hover:bg-primary/20 transition-colors">
                <FaTiktok className="h-5 w-5 text-primary" />
              </a>
              <a href="https://wa.me/60360641331" target="_blank" rel="noopener noreferrer" className="p-2 bg-primary/10 rounded-full hover:bg-primary/20 transition-colors">
                <FaWhatsapp className="h-5 w-5 text-primary" />
              </a>
            </div>
            <p className="text-xs text-muted-foreground">
              Kemaskini Terkini : Selasa 09 Disember 2025, 04:28:06.
            </p>
            <div className="flex items-center gap-2">
              ...
              <div className="flex gap-0.5">
                {formatVisitorCount(visitorCount).map((digit, index) => (
                  <span
                    key={index}
                    className="bg-red-600 text-white text-xs font-mono px-1.5 py-0.5 rounded"
                  >
                    {digit}
                  </span>
                ))}
